    ...
    <body class="">
        ...
        <div class="p-2 mb-4 container">
            ...
            <p class="p-3 lead mb-3">
                回答数が絶望的に足りていないため、協力してくださった方の中から抽選で10名様にAmazonギフト券1000円分をプレゼントするキャンペーンを実施しています。</br>希望する方はPart3(事後アンケート)にてメールアドレスをお書きください。</br>キャンペーンの抽選対象となる回答期限は11/18(水)の正午までとし、当選者には当日の午後にメールを送らせていただきます。
            </p>
